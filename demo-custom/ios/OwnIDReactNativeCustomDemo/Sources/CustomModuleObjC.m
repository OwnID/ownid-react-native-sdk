...
@interface RCT_EXTERN_MODULE (CustomAuthModule, NSObject)
...
RCT_EXTERN_METHOD(login:(NSString *)loginId password:(NSString *)password resolve:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject)
