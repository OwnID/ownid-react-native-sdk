...
extension OwnID.ReactGigyaSDK {
    ...
    static let version = "3.9.2"
}

extension OwnID {
    public final class ReactGigyaSDK {
        // MARK: Setup
        ...
        public static func configure<T: GigyaAccountProtocol>(
            _ dataType: T.Type,
            plistUrl: URL,
        ...
        public static func registrationViewModel<T: GigyaAccountProtocol>(
            instance: GigyaCore<T>,
        ...
        public static func createRegisterView(
            viewModel: OwnID.FlowsSDK.RegisterView.ViewModel,
            visualConfig: OwnID.UISDK.VisualLookConfig = .init()
        ) -> OwnID.FlowsSDK.RegisterView {
        ...
        /// - Parameters:
        ///   - instance: Instance of Gigya SDK (with custom schema if needed)
        public static func loginViewModel<T: GigyaAccountProtocol>(
            instance: GigyaCore<T>,
            loginIdPublisher: OwnID.CoreSDK.LoginIdPublisher
        ) -> OwnID.FlowsSDK.LoginView.ViewModel {
